...
def dec_swap_last_two( nibbles ):
    ...
    return bytearray( [ nibbles[0], nibbles[1], nibbles[3], nibbles[2] ] )
...
while (input1 != "a" and input1 != "b" and input1 != "c" and input1 != "d" and input1 != "e"):
    input1 = input("Please enter a letter from a - e to test a function\n: ")
...
if input1 == "c":
    ans = \
    dec_swap_last_two( dec_byte_to_nibbles( 0b01111110 ) )
    ans2 = dec_convert_nibbles_to_byte( ans )
